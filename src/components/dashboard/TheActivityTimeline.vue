...
const fetchSummary = async () => {
  if (!userId) return;
  try {
    const res = await fetch('https://c44d-2405-9800-b861-96e-d38-cc71-74cd-d0c1.ngrok-free.app/package/backend/quarter_summary_Q.php', {
      method: 'POST',
...
<template>
  ...
  <tr>
    ...
    <th class="text-h6" :colspan="visibleYears.length + 1" style="text-align: center; border-bottom: 2px solid #00A6D4;">
