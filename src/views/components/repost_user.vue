...
async function register() {
    ...
    try {
        ...
        const res = await fetch('http://localhost/package/backend/register.php', {
            method: 'POST',
            body: formData
        });
...
const fetchMembers = async () => {
    try {
        let url = 'http://localhost/package/backend/get_members_master.php';
        ...
        if (selectedYearFilter.value && selectedMonthFilter.value) {
            ...
            url = `http://localhost/package/backend/get_members_master.php?buddhist_year=${buddhistYear}&month_number=${monthNumber}`;
            ...
            url = `http://localhost/package/backend/get_members_master.php?buddhist_year=${buddhistYear}`;
        }
...
function getProfileImageUrl(path: string | null): string {
    ...
    return `http://localhost/package/backend/${path}`;
}
...
async function updateMember(isActive: { value: boolean }) {
    ...
    try {
        ...
        const res = await fetch('http://localhost/package/backend/edit_profile.php', {
            method: 'POST',
            body: formData
        });
