...
<template>
    ...
    <h5 class="card-subtitle" style="text-align: left">{{ dynamicUnitSubtitle }}</h5>
        ...
        <v-col cols="12" sm="12" lg="12">
            <v-card elevation="10" style="position: relative;"> <v-overlay
    ...
    <template v-for="region in regions" :key="region">
        ...
        >
            ...
            <td v-for="month_item in displayedMonths" :key="region + field + month_item.value" style="text-align: right; vertical-align: top;"> <div>
                    ...
                    <span v-if="showMoM" style="font-size: 9px !important;" v-html="getMoMFormatted_VerticalTotal(month_item.value, region, field)"></span>
                </div>
            </td>
            
            <td style="background-color: #fff3e0; text-align: right; vertical-align: top;" :style="getHighlightStyle(field)"> <div>
    ...
    >
        ...
        <td v-for="month_item in displayedMonths" :key="'total-' + month_item.value + field" style="text-align: right; vertical-align: top;"> <div>
                ...
                <span v-if="showMoM" style="font-size: 9px !important;" v-html="getMoMFormatted_GrandTotal(month_item.value, field)"></span>
            </div>
        </td>
