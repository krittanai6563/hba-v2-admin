...
const fetchMembers = async () => {
    try {
        let url = 'https://thhbaadmin.infinityfreeapp.com/backend/get_members.php';
        ...
        if (selectedYearFilter.value && selectedMonthFilter.value) {
            ...
            url = `https://thhbaadmin.infinityfreeapp.com/backend/get_members.php?buddhist_year=${buddhistYear}&month_number=${monthNumber}`;
            ...
            url = `https://thhbaadmin.infinityfreeapp.com/backend/get_members.php?buddhist_year=${buddhistYear}`;
        }
