...
const fetchMembers = async () => {
    try {
        let url = 'http://localhost/package/backend/get_members.php';
        ...
        if (selectedYearFilter.value && selectedMonthFilter.value) {
            ...
            url = `http://localhost/package/backend/get_members.php?buddhist_year=${buddhistYear}&month_number=${monthNumber}`;
            ...
            url = `http://localhost/package/backend/get_members.php?buddhist_year=${buddhistYear}`;
        }
