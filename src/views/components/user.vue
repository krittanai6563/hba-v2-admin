...
const fetchMembers = async () => {
    try {
        let url = 'https://c44d-2405-9800-b861-96e-d38-cc71-74cd-d0c1.ngrok-free.app/package/backend/get_members.php';
        ...
        if (selectedYearFilter.value && selectedMonthFilter.value) {
            ...
            url = `https://c44d-2405-9800-b861-96e-d38-cc71-74cd-d0c1.ngrok-free.app/package/backend/get_members.php?buddhist_year=${buddhistYear}&month_number=${monthNumber}`;
            ...
            url = `https://c44d-2405-9800-b861-96e-d38-cc71-74cd-d0c1.ngrok-free.app/package/backend/get_members.php?buddhist_year=${buddhistYear}`;
        }
