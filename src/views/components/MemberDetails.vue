...
const fetchMemberDetails = async () => {
  ...
  try {
    const response = await fetch(`https://thhbaadmin.infinityfreeapp.com/backend/get_members_master-D.php?id=${memberId.value}&buddhist_year=${buddhistYear.value}&month_number=${monthNumber.value}`);
