...
const getRegionField = (region: string, field: RegionField): number => {
    ...
    return field === 'price_per_sqm' ? (entry.usable_area > 0 ? Math.round(entry.total_value / entry.usable_area) : 0) : entry[field];
};
...
const totalUnit = computed(() => regions.reduce((sum, region) => sum + getRegionField(region, 'unit'), 0));

const totalValue = computed(() => regions.reduce((sum, region) => sum + getRegionField(region, 'total_value'), 0));

const totalArea = computed(() => regions.reduce((sum, region) => sum + getRegionField(region, 'usable_area'), 0));
...
const fetchUserStatus = async () => {
    ...
    try {
        ...
        const res = await fetch('https://6e9fdf451a56.ngrok-free.app/package/backend/data_and_email.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(payload)
        });
...
<template>
    ...
    <v-row v-if="statusMessage && userRole === 'user'">
        <v-alert
            density="compact"
            v-bind:type="statusMessage === 'กรอกข้อมูลเรียบร้อย' ? 'success' : 'error'"
            :text="statusMessage"
                            ...
                            <div class="d-flex ga-2">
                                <div>
                                    ...
                                    <h5 class="text-h5 text-primary mb-0 font-weight-medium mt-n1">
                                        {{ latestMonthValue.toLocaleString('th-TH') }} บาท
                                    </h5>
                                </div>
                                <div>
                                    <div class="vue-apexcharts" style="min-height: 40px">
                                        <div
                                            id="apexchartsqycvbxyj"
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <g id="SvgjsG1596" class="apexcharts-yaxis" rel="0" transform="translate(-18, 0)"></g>
                                                <g
                                                    id="SvgjsG1545"
                                                ...
                                                >
                                                    <defs id="SvgjsDefs1544">
                                                        <linearGradient id="SvgjsLinearGradient1547" x1="0" y1="0" x2="0" y2="1">
                                                            <stop
                                                                id="SvgjsStop1548"
                                                                stop-opacity="0.4"
                                                    ...
                                                    <rect
                                                        id="SvgjsRect1551"
                                                        width="3.809523809523809"
                                                        height="40"
                                                        x="28.190513974144345"
                                                        y="0"
                                                        rx="0"
                                                        ry="0"
                                                        opacity="1"
                                                        ...
                                                        filter="none"
                                                        fill-opacity="0.9"
                                                        x1="28.190513974144345"
                                                        x2="28.190513974144345"
                                                    ></rect>
                                                    <g id="SvgjsG1575" class="apexcharts-grid">
                                                        <g id="SvgjsG1576" class="apexcharts-gridlines-horizontal" style="display: none">
                                                            <line
                                                                id="SvgjsLine1579"
                                                                x1="-8.333333333333334"
                                                                y1="0"
                                                                x2="61.666666666666664"
                                                                y2="0"
                                                                stroke="#e0e0e0"
                                                                stroke-dasharray="0"
                                                                stroke-linecap="butt"
                                                        ...
                                                        <g id="SvgjsG1577" class="apexcharts-gridlines-vertical" style="display: none"></g>
                                                        <line
                                                            id="SvgjsLine1585"
                                                            x1="0"
                                                            y1="40"
                                                            x2="53.33333333333333"
                                                            y2="40"
                                                            stroke="transparent"
                                                            stroke-dasharray="0"
                                                            stroke-linecap="butt"
                                                    ...
                                                    <g id="SvgjsG1578" class="apexcharts-grid-borders" style="display: none"></g>
                                                    <g id="SvgjsG1554" class="apexcharts-bar-series apexcharts-plot-series">
                                                        <g
                                                            id="SvgjsG1555"
                                                        ...
                                                        >
                                                            <path
                                                                ...
                                                                cy="30"
                                                                cx="1.9047619047619044"
                                                                j="0"
                                                                val="5"
                                                                barHeight="10"
                                                                barWidth="3.809523809523809"
                                                            ></path>
                                                            <path
                                                                id="SvgjsPath1562"
                                                            ...
                                                            <g id="SvgjsG1557" class="apexcharts-bar-goals-markers">
                                                                <g
                                                                    ...
                                                                    clip-path="url(#gridRectMarkerMaskqycvbxyj)"
                                                                ></g>
                                                                <g
                                                                    id="SvgjsG1561"
                                                                    className="apexcharts-bar-goals-groups"
                                            ...
                                            <div class="apexcharts-tooltip apexcharts-theme-dark" style="left: -20.2589px; top: 11.5px">
                                                <div
                                                ...
                                                >
                                                    <span
                                                        ...
                                                        style="background-color: rgba(var(--v-theme-primary))"
                                                    ></span>
