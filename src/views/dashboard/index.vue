...
const fetchRegionSummary = async () => {
    ...
    try {
        const res = await fetch('https://06da-1-47-223-210.ngrok-free.app/package/backend/file.php', {
            method: 'POST',
...
const fetchUserStatus = async () => {
  ...
  try {
    ...
    const res = await fetch('https://06da-1-47-223-210.ngrok-free.app/package/backend/data_and_email.php', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(payload),
    });
